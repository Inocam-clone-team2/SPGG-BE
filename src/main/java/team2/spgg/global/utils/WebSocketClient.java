...
public class WebSocketClient {
    ...
    private static void enterChatRoom(String roomId, String userName) {
        team2.spgg.domain.chat.dto.ChatMessage chatMessage = new team2.spgg.domain.chat.dto.ChatMessage();
        chatMessage.setType(team2.spgg.domain.chat.dto.ChatMessage.MessageType.ENTER);
    ...
    private static void sendMessage(String roomId, String userName, String message) {
        team2.spgg.domain.chat.dto.ChatMessage chatMessage = new team2.spgg.domain.chat.dto.ChatMessage();
        chatMessage.setType(team2.spgg.domain.chat.dto.ChatMessage.MessageType.TALK);
        chatMessage.setRoomId(roomId);
        chatMessage.setSender(userName);
